...
let modulePaths = {
 ...
 "web/add-elements": "add-elements.sound.ddc"
};
if(!window.$dartLoader) {
   window.$dartLoader = {
     appDigests: _currentDirectory + 'add-elements.digests',
...
define("add-elements.dart.bootstrap", ["web/add-elements", "dart_sdk"], function(app, dart_sdk) {
  ...
  (app.web__add_elements || app.add$45elements).main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        ...
        if (childName === "add-elements.dart") {
          // Clear static caches.
  ...
  dart_sdk.dart.trackLibraries("add-elements.dart.bootstrap", {
    "add-elements.dart.bootstrap": bootstrap
  }, '');
  return {
    bootstrap: bootstrap
  };
