...
let modulePaths = {
 ...
 "web/remove-elements": "remove-elements.sound.ddc"
};
if(!window.$dartLoader) {
   window.$dartLoader = {
     appDigests: _currentDirectory + 'remove-elements.digests',
...
define("remove-elements.dart.bootstrap", ["web/remove-elements", "dart_sdk"], function(app, dart_sdk) {
  ...
  (app.web__remove_elements || app.remove$45elements).main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        ...
        if (childName === "remove-elements.dart") {
          // Clear static caches.
  ...
  dart_sdk.dart.trackLibraries("remove-elements.dart.bootstrap", {
    "remove-elements.dart.bootstrap": bootstrap
  }, '');
  return {
    bootstrap: bootstrap
  };
