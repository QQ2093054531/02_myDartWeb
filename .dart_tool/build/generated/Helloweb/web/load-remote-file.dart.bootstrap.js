...
let modulePaths = {
 ...
 "web/load-remote-file": "load-remote-file.sound.ddc"
};
if(!window.$dartLoader) {
   window.$dartLoader = {
     appDigests: _currentDirectory + 'load-remote-file.digests',
...
define("load-remote-file.dart.bootstrap", ["web/load-remote-file", "dart_sdk"], function(app, dart_sdk) {
  ...
  (app.web__load_remote_file || app.load$45remote$45file).main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        ...
        if (childName === "load-remote-file.dart") {
          // Clear static caches.
  ...
  dart_sdk.dart.trackLibraries("load-remote-file.dart.bootstrap", {
    "load-remote-file.dart.bootstrap": bootstrap
  }, '');
  return {
    bootstrap: bootstrap
  };
